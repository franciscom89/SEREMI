<?php
 ...
 <div id="trabajo" align="center">
        <h1>Informe recursos Fisicos</h1>
        <br />
...
$result = mysql_query("SELECT * FROM  fisico where fecha_creacion BETWEEN '$fini' and '$fterm'");
?>
<form action="informe_fisico.php" method="post">
