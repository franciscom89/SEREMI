...
@$bodega=$_GET['bodega'];
$usuario_bodega=$_SESSION['nombre_sessionc'];
...
$this->SetX(15);
$this->Cell(70,6,$usuario_bodega,0,0,'C',1);
$this->SetX(85);
...
window.open('<?php echo $nombre_variable;?>','_blank');
