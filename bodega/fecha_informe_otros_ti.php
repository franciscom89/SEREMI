...
$result = mysql_query("SELECT * FROM  otros_ti where fecha_creacion BETWEEN '$fini' and '$fterm'");
?>
<form action="informe_otros_ti.php" method="post">
